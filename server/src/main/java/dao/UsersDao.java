...
public class UsersDao {
    ...
    private final String getUserByLoginQuery = "SELECT login, password, prefix, suffix FROM Users WHERE login = ? LIMIT 1;";
    ...
    public User getByLogin(String login) {
        try {
            ...
            if (userFromDb.next()) {
                ...
                return new User(login_, hashedPassword, prefix, suffix);
            }
            return null;
